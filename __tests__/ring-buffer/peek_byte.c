...
TEST_CASE("should work as expected") {
	...
	libnapc_RingBuffer_removeByte(&rbuffer, NULL); // remove '1'
	libnapc_RingBuffer_removeByte(&rbuffer, NULL); // remove '2'
	libnapc_RingBuffer_removeByte(&rbuffer, NULL); // remove '3'
	libnapc_RingBuffer_removeByte(&rbuffer, NULL); // remove '4'
